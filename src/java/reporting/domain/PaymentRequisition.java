...
public class PaymentRequisition extends AbstractEntity implements Serializable{
    ...
    public int getApproval_state_id() {
        return approval_state_id;
    }

    public void setApproval_state_id(int approval_state_id) {
